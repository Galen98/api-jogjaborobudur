        ...
        <div class="row">
            <div class="col-md-6 text-center">
                ...
                <p style="text-align: center;">
                    Hello {!! $name !!}, please click the link below to complete your payment for <strong>{!! $travelName !!}</strong> on <strong>{{ $travelDate }}</strong>.
                </p>
            
                <p style="text-align: center;">
                    Total payment: <strong>{!! $currency !!} {!! $amount !!}</strong>
                </p>
            
                <center>
                    <a href="https://jogjaborobudur.com/payment/{!! $token !!}">
